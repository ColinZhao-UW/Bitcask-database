...
var (
	...
	ErrDatabaseDirPathEmpty    = errors.New("database dir path is empty")
	ErrDatabaseFileSizeInvalid = errors.New("database file size must be greater than 0")
	...
	ErrMergeRatioError         = errors.New("the merge ratio is wrong")
)
